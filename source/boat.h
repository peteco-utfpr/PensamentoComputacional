...
*/
class Boat : public Clickable, public sf::Sprite{
    public:
    ...
    public:
        Boat(sf::Texture* texture = NULL, bool isOnTheLeft = false, int quantChar = 2, sf::Vector2f scale = {1.0f, 1.0f}, sf::Vector2f position = {0.0f, 0.0f});
        void moveBoat();
